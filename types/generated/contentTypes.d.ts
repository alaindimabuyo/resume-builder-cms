...
export interface ApiUserResumeBuilderUserResumeBuilder
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_resume_builders';
  info: {
    description: '';
    displayName: 'User Resume Builder';
    pluralName: 'user-resume-builders';
    singularName: 'user-resume-builder';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-resume-builder.user-resume-builder'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-resume-builder.user-resume-builder': ApiUserResumeBuilderUserResumeBuilder;
